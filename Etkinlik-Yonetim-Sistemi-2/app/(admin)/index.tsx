...
export default function AdminDashboard() {
    ...
    const fetchStats = async () => {
        setLoading(true);
        try {
            const response = await axios.get('/mobile/admin/panel');
    ...
    return (
        ...
        >
            <View style={styles.welcomeContainer}>
                <Text style={styles.welcomeText}>Hoş Geldin, Admin 👋</Text>
                <Text style={styles.subText}>Sistem yönetimi için kontrol paneli.</Text>
            </View>
            ...
            <View style={styles.statsGrid}>
                ...
                <View style={styles.card}>
                    <Ionicons name="people" size={30} color="#1d9bf0" />
                ...
                <View style={styles.card}>
                    ...
                    <Text style={styles.cardValue}>{stats.onaylanan}</Text>
