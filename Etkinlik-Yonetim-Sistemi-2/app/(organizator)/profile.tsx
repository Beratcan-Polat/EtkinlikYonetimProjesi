    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.header}>
                <Text style={styles.title}>Profil - {user.kullaniciAdi}</Text>
                <Text style={styles.subtitle}>Bilgilerini buradan güncelleyebilirsin.</Text>
            ...
            <View style={styles.form}>
                ...
                <TouchableOpacity style={styles.saveButton} onPress={handleUpdate} disabled={loading}>
                    <Text style={styles.saveButtonText}>{loading ? 'Güncelleniyor...' : 'Bilgilerimi Güncelle'}</Text>
                </TouchableOpacity>
